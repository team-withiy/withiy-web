...
const NetworkError: FallbackRenderType = ({ resetErrorBoundary }) => {
  return (
    <DvhHeightLayout heightType="height" dvh={100} className={styles.wrapper}>
      <main className={styles.main} data-testid="network-error">
        <section className={styles.content}>
          <section className={styles.content}>
            ...
            <p className={styles.description}>
              잠시 연결이 불안해요
              <br />
              <small className={styles.small}>다시 한 번 연결해볼까요?</small>
            </p>
          </section>
        </section>
